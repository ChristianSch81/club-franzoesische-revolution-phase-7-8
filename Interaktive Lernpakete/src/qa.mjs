...
for (const filename of expectedFiles) {
  ...
  if (filename === "index.html") {
    ...
    assert((html.match(/class="package-preview"/g) || []).length === 7, `${filename}: sieben Paketbilder erwartet.`);
  }
  ...
  if (filename === "index.html") {
    ...
    assert(packageLinks.length === 17, `index.html: erwartet 10 Schaltflächen- und 7 Bildlinks, erhalten ${packageLinks.length}.`);
